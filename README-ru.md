...
- [Навигация по репозиторию](docs/navigation-ru.md) — найти документацию, исходный код и проверки
  для конкретной задачи
- [Архитектура репозитория](docs/architecture-ru.md) — разобраться в точках входа, границах
  исходного кода, сборке и тестах
