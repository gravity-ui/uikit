...
export const Default: Story = {
    ...
    render: (args) => (
        <Accordion {...args}>
            <Accordion.Item summary="Accordion header 1">
                <Text>Content of the first accordion item.</Text>
            </Accordion.Item>
            ...
            <Accordion.Item summary="Accordion header 3">
                <Text>Content of the third accordion item.</Text>
            </Accordion.Item>
        </Accordion>
    ),
};
            ...
            <Accordion {...args} defaultValue={'settings'}>
                <Accordion.Item summary="Settings" value="settings">
                    <Flex direction="column" gap={2}>
                        <Text>Configure various application settings here.</Text>
                        <Button size="s">Save Settings</Button>
                    </Flex>
                </Accordion.Item>
                <Accordion.Item summary="Notifications" value="notifications">
                    <Text>Manage notification preferences and settings.</Text>
                </Accordion.Item>
                <Accordion.Item summary="Security" value="security">
                    <Text>Security and privacy configuration options.</Text>
                </Accordion.Item>
            </Accordion>
        </React.Fragment>
    ),
