...
| disableFocusTrap      | Если установлено значение `true`, фокус можно перемещать за пределы модального окна.                                    | `Boolean`                                                                                      |                       |
| disableAutoFocus      | Если установлено значение `true`, при открытии модального окна фокус не будет автоматически перемещаться на него.       | `Boolean`                                                                                      |                       |
| onTransitionEnter     | Обработчик события, вызываемый, когда начинается анимация открытия диалога.                                             | `() => void`                                                                                   |                       |
| onTransitionEntered   | Обработчик события, вызываемый по завершении анимации открытия диалога.                                                 | `() => void`                                                                                   |                       |
| onTransitionExit      | Обработчик события, вызываемый, когда начинается анимация закрытия диалога.                                             | `() => void`                                                                                   |                       |
| onTransitionExited    | Обработчик события, вызываемый по завершении анимации закрытия диалога.                                                 | `() => void`                                                                                   |                       |
| restoreFocusRef       | Элемент, получающий фокус при закрытии диалога.                                                                         | `React.RefObject`                                                                              |                       |
