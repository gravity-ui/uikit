...
| disableAnimation      | Skips both opening and closing animations when `true`, or only the specified phase with `"open"` or `"close"`. Height transitions are unchanged. | `boolean \| "open" \| "close"`                                                                   | `false`     |
