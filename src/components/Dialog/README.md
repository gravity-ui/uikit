...
| disableFocusTrap      | If true, the modal will not prevent focus from leaving it while open                          | `Boolean`                                                                                      |           |
| disableAutoFocus      | If true, the modal will not automatically shift focus to itself when it opens                 | `Boolean`                                                                                      |           |
