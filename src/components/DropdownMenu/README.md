...
The example above is oversimplified to demonstrate the idea of the customizable menu toggle. In a real-life application, it is generally recommended that the clickable menu toggle be a component accessible with a keyboard and other assistive technologies (such as a button).
...
| `icon`                     | An icon of the default `switcher`.                                                                  |                 `React.ReactNode`                  | Ellipsis icon |
