...
<Source language="tsx" code={LinkExampleViewNormal.code}/>
<LinkExampleViewNormal/>
...
<Source language="tsx" code={LinkExampleViewPrimary.code}/>
<LinkExampleViewPrimary/>
...
<Source language="tsx" code={LinkExampleViewSecondary.code}/>
<LinkExampleViewSecondary/>

## Href
`href` property is optional. If it is absent, then Link wil act like Button.
<Source language="tsx" code={LinkExampleHref.code}/>
<LinkExampleHref/>

## Usage
Сan be used as an independent text element, or as part of the text
<Source language="tsx" code={LinkExampleUsage.code}/>
<LinkExampleUsage/>
