...
Передайте роутерный `Link` в `component` и возвращайте его props из `getItemProps`.
Используйте параметр типа `GetPaginationItemProps`, чтобы типизировать результат явно.
