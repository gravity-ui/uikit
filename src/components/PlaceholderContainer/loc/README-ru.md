...
`PlaceholderContainer` — это компонент для отображения контента с изображениями, текстовой информацией и контролами действий.
...
Контент `PlaceholderContainer` берется из секций заголовка и описания, которые задаются через соответствующие свойства. Для отображения пользовательского контента используйте свойство `content`.
...
| content     | Используется для рендеринга узла вместо контента (заголовка, описания и действий).      |                               `React.ReactNode`                               |                       |
| actions     | Используется для рендеринга массива кнопок или пользовательского узла.                  |     `PlaceholderContainerActionProps[]`<br/> `\|        React.ReactNode `     |                       |
