...
| popupWidth                      | `number \| 'fit' \| 'outfit'`           | `'outfit'`      | Popup width. fit - fit control width. outfit - apply width of widest option, 90vw or width of control if it wider than 90vw   |
