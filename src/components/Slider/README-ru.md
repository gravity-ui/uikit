...
| [startPoint](#стартовая-точка-трека)        | Задает стартовое значение, относительно которого будет заполняться трек слайдера. При использовании слайдера диапазона, это свойство игнорируется.                                        |                       `number`                       |                       |
