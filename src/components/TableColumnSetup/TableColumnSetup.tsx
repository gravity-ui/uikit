...
import type {
    TableColumnSetupItem as NewTableColumnSetupItem,
    TableColumnSetupApplyMode,
} from '../Table/hoc/withTableSettings/TableColumnSetup/TableColumnSetup';
...
export type {TableColumnSetupApplyMode};
