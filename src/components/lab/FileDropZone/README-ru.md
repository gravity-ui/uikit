...
| onUpdateRejected | Коллбэк, вызываемый при отклонении файлов из-за неподходящего типа или из-за передачи больше одного файла в режиме загрузки одного файла |                `(items: DropZoneFileRejection[]) => void`                 |                                            |
