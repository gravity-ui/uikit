...
export interface ListVirtualizedRootProps {
    ...
    rowIds: string[];
    /**
     * Индекс строки с roving tab-stop в `rowIds` (активной, а без активной —
     * первой навигабельной); −1, если опций нет. Рендерер обязан держать её
     * смонтированной всегда: выгрузка сфокусированной строки роняет фокус
     * на body, выгрузка tab-stop делает список недостижимым по Tab
     */
    pinnedIndex: number;
