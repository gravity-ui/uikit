...
- `size` - default column width (if omitted the column will occupy all free space in the row)
- For each [screen size](#screen-sizes) (`s`, `m`, `l`,`xl`, `xxl`, `xxxl`) sets the width of the column.
...
>
    <Col
        // will be apply for `xs` and `s`
        size="12"
        // will be apply for `m` and `l`
        m="6"
        // will be apply for `xl`, `xxl` ...
        xl="4"
    >
        ...
    </Col>
