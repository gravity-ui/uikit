...
export const baseStyleHandlers: StyleHandlers<keyof BaseStyleProps> = {
    ...
    width: ['inlineSize', getSpacingValue],
    minWidth: ['minInlineSize', getSpacingValue],
    maxWidth: ['maxInlineSize', getSpacingValue],
    height: ['blockSize', getSpacingValue],
    minHeight: ['minBlockSize', getSpacingValue],
    maxHeight: ['maxBlockSize', getSpacingValue],
    position: ['position'],
