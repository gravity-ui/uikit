...
const baseStyleHandlers: StyleHandlers<BaseStyleProperties> = {
    ...
    top: ['insetBlockStart', getSpacingValue],
    bottom: ['insetBlockEnd', getSpacingValue],
    start: ['insetInlineStart', getSpacingValue],
    end: ['insetInlineEnd', getSpacingValue],
    zIndex: ['zIndex'],
    margin: ['margin', getSpacingValue],
    marginInline: ['marginInline', getSpacingValue],
    marginStart: ['marginInlineStart', getSpacingValue],
    marginEnd: ['marginInlineEnd', getSpacingValue],
    marginBlock: ['marginBlock', getSpacingValue],
    marginTop: ['marginBlockStart', getSpacingValue],
    marginBottom: ['marginBlockEnd', getSpacingValue],
    padding: ['padding', getSpacingValue],
    paddingInline: ['paddingInline', getSpacingValue],
    paddingStart: ['paddingInlineStart', getSpacingValue],
    paddingEnd: ['paddingInlineEnd', getSpacingValue],
    paddingBlock: ['paddingBlock', getSpacingValue],
    paddingTop: ['paddingBlockStart', getSpacingValue],
    paddingBottom: ['paddingBlockEnd', getSpacingValue],
    ...
    borderStartColor: ['borderInlineStartColor', getLineColorValue],
    borderEndColor: ['borderInlineEndColor', getLineColorValue],
    borderTopColor: ['borderTopColor', getLineColorValue],
    borderBottomColor: ['borderBottomColor', getLineColorValue],
    borderRadius: ['borderRadius', getRadiusValue],
    borderTopStartRadius: ['borderStartStartRadius', getRadiusValue],
    borderTopEndRadius: ['borderStartEndRadius', getRadiusValue],
    borderBottomStartRadius: ['borderEndStartRadius', getRadiusValue],
    borderBottomEndRadius: ['borderEndEndRadius', getRadiusValue],
};
