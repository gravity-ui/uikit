...
| `moreControlProps` (`virtualizationThreshold`, `popupWidth`)                     | _(none)_                      | the new "More" menu (`TabListCollapseItem`) is a plain `Menu`, not a virtualized `Select` — there's nothing to tune besides `moreLabel`                                                                                                                                                 |
